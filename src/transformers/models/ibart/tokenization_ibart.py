...
class IBartTokenizer(BartTokenizer):
    """
    Construct a IBART tokenizer.

    :class:`~transformers.IBartTokenizer` is identical to :class:`~transformers.BartTokenizer` and runs end-to-end
